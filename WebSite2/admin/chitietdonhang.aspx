<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chitietdonhang.aspx.cs" Inherits="admin_Default" %>
            ...
            <td>
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>Hiển thị thông in của tên khách hàng, nội dung,số điện thoại,email liên lạc,mã sản phẩm.....</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
