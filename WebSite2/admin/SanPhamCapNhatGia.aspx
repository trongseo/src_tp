<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SanPhamCapNhatGia.aspx.cs" Inherits="admin_Default" %>
                ...
                <div>
                    ...
                    <table class="auto-style3">
                        <tr>
                            <td>Mã sản phẩm</td>
                            <td>
                                <strong>TV4525</strong></td>
                        </tr>
                        <tr>
                            <td>
                                <input id="Button2" type="button" value="Thêm" /></td>
                            <td>
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <input id="Text2" type="text" /></td>
                                        <td>
                                <input id="Button3" type="button" value="Xóa" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <input id="Button1" type="button" value="Cập nhật" /></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
