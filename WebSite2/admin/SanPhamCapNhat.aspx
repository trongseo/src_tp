<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SanPhamCapNhat.aspx.cs" Inherits="admin_Default" %>
                ...
                <div>
                    ...
                    <table class="auto-style3">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="S1"></textarea></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <input id="Button1" type="button" value="Cập nhật" />
                                <input id="Button2" type="button" value="Cập nhật &gt;&gt;" /></td>
                        </tr>
                    </table>
